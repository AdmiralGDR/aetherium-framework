...
*Русский. Английская версия: [`../en/autowiring.md`](../../en/reference/autowiring.md).*
...
2. Выстраивает их в детерминированный DAG инициализации через `InitOrdering` — та же сортировка Кана,
   ...
   ([`injector.md`](../explanation/injector.md)). Цикл или дубликат id **валит сборку**, а не угадывает.
...
и вызывает его ([`game-integration.md`](../explanation/game-integration.md)) — методы init выполняются как обычные
